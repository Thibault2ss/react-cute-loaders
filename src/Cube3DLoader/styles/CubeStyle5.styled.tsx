...
export const CubeStyle5 = styled.div<CubeStyleProps>`
  position: relative;
  height: ${(props) => props.size}px;
  width: ${(props) => props.size}px;
  animation: ${animation} 5000ms cubic-bezier(0.65, 0, 0.35, 1) infinite;
  ...
  > .face {
    ...
    &.left {
      animation-delay: 0ms;
      transform: rotateX(-55deg) rotateY(135deg)
    ...
    &.back {
      animation-delay: -666ms;
      transform: rotateX(-55deg) rotateY(225deg)
        translateZ(${(props) => props.size / 2}px);
    }
    ...
    &.right {
      animation-delay: 0ms;
      transform: rotateX(-55deg) rotateY(315deg)
        translateZ(${(props) => props.size / 2}px);
    }
  }
`
